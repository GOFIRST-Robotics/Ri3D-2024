...
public class IntakeCommand extends Command {
  ...
  public void initialize() {
    m_intakeSubsystem.setPower(this.reverse ? Constants.UPPER_INTAKE_BAR_SPEED : -1 * Constants.UPPER_INTAKE_BAR_SPEED, this.reverse ? Constants.LOWER_INTAKE_BAR_SPEED : -1 * Constants.LOWER_INTAKE_BAR_SPEED);
